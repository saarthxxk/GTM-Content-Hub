...
function load(slug: string) {
  ...
  if (!content || content.type !== "case_study" || content.status !== "published") return null;
  return content;
}
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: { title: content.metadata.metaTitle || content.title, description: content.metadata.metaDescription, type: "article" },
